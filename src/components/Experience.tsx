                    ...
                    {experiences.map((exp, i) => (
                        ...
                        >
                            ...
                            <div style={{ flex: '0 0 220px' }}>
                                <div style={{ fontSize: '4rem', fontWeight: 900, color: 'var(--accent-color)', opacity: 0.08, lineHeight: 1, fontVariantNumeric: 'tabular-nums', marginBottom: '-12px' }}>
                                    {exp.index}
                                </div>
                                <span style={{
                                    display: 'inline-block', fontSize: '0.72rem', fontWeight: 600,
                                    letterSpacing: '0.05em', textTransform: 'uppercase',
                                    color: 'var(--accent-color)', background: 'rgba(0,113,227,0.1)',
                                ...
                                <p className="font-mono" style={{ fontSize: '0.8rem', color: 'var(--accent-color)', fontWeight: 600 }}>
                                    {exp.period}
                                </p>
                                ...
                                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '24px' }}>
                                    {exp.highlights.map((h, j) => (
                                        <li key={j} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', fontSize: '0.95rem', lineHeight: 1.65 }}>
                                            <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--accent-color)', flexShrink: 0, marginTop: '8px' }} />
